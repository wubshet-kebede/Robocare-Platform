...
<template>
  <ClientOnly>
    <TransitionRoot as="template" :show="open">
      <Dialog
        as="div"
        class="relative z-[200] overflow-hidden"
      ...
      >
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
          <div
            class="flex min-h-full items-end justify-center p-4 max-md:p-0 text-center sm:items-center sm:p-0"
          >
            <TransitionChild
              as="template"
              enter="ease-out duration-300"
            ...
            >
              ...
              >
                <div
                  class="absolute w-full justify-between right-0 top-0 px-4 pt-4 flex"
                >
                  <DialogTitle
                    as="h3"
                  ...
                  <button
                    type="button"
                    class="px-1 hover:bg-gray-100 shrink-0 rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-100 duration-100"
                    @click="open = false"
                  >
